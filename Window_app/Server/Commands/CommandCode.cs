...
namespace SolarServer.Commands
{
        ...
        public const int CLIENT_LOGOUT = 6;
        public const int SET_PARAMETER_COMMAND = 7;
        public const int SET_MODE_COMMAND = 8;
        public const int UPDATE_MACHINE_STATUS = 9;
        public const int INITILIZE_COMMAND = 10;
        public const int UPDATE_IMAGE_COMMAND = 11;
        public const int GET_PLANTMAP_COMMAND = 12;
        public const int UPDATE_PLANT_MAP_POSITION_COMMAND = 13;
    }
